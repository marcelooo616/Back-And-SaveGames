...
import com.ecommerce.savegames.service.UsuarioService;
...
public class UsuarioControllerTest {
		...
		public void deveListarApenasUmUsuario() {
			 ...
			 * de dados, o Optional evitará o erro NullPointerException (Objeto Nulo).
			 */
			Optional<Usuario> usuarioBusca = usuarioService.cadastrarUsuario(new Usuario(0L,"Laura Santolia", "laura_santolia@email.com.br", "laura12345"));
